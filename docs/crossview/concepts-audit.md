...
Analysis of `docs/crossview/concepts.md` (the /crossview Concepts tab) with one
...
6. **D8 "exactly 1 dispute precedent"** — check the Dispute Resolutions Active
   Data content.
7. **D1 accord crossview** ("Key Details + Substantive Terms" per accord) —
...
| #7 accord crossview "Key Details + Substantive Terms" (D1) | ✅ 10/10 subtrees have exactly "Accord Key Details" + "Accord Substantive Terms"; caveat: Accord 2 is titled just "Prime Program", so the title-template signature misses it |
