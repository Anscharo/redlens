...
-->
## 2026-09-08
- Added a Monthly Settlement Cycle overview to the Radar front page: Sky's take as a pie, orbited by each Prime's month as a pie (or, with the flow pill, a three-stage chart of sources, Primes and Sky), with a prime-earnings timeline that plays through the months
...
- Linked each Prime Agent monthly settlement month to its Sky Forum post
