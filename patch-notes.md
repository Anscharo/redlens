...
## 2026-09-24
- Chat answers now mark which sources back them, say how sure that check is when you hover the source, jump to a line the source contradicts or doesn't cover, and say when a reply didn't answer the question or skipped part of it
