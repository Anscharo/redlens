...
pnpm settlements:parse # fetch soterlabs/settlement-reports xlsx (or `--dir`) → public/settlements.json + coverage/reconciliation stats. Off the `pnpm build` chain (REPRO=1 is offline).
