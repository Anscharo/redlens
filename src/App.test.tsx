...
// OnchainAddressesReport (unlike the other report routes above) is left real —
// it's the route-mount smoke test below — so its data loaders need a resolved
// value; empty is enough to clear the loading state and reach the real table.
