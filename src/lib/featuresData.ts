    ...
    features: [
      {
        ...
        how: [
          ...
          "Look at the sources chips under an answer: where each cited document has been checked against the sentences citing it, a ✓ means the document backs them, a muted mark means it doesn't cover every line citing it, and a warning means it may say otherwise — hover the source to see how sure that check is, and for a warning which line it is. The marks are shown on the live answer only; a reopened chat lists its sources without them.",
