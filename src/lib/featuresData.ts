    ...
    features: [
      {
        ...
        how: [
          ...
          "Responsibilities shows up to five Active Data rows; `View all in Active Data Report` opens the rest.",
          "On a Prime Agent, Omni lists each shared emergency-response protocol with a short essence of its summary.",
        ],
      },
      {
