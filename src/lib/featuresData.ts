    ...
    features: [
      ...
      },
      {
        ...
        how: [
          ...
          "Click a month column in the To Sky by month chart to switch the orbital chart and the figures under it, or press its ▶ play button to step through the months (it opens paused on the latest).",
