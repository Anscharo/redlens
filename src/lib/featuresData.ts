    ...
    features: [
      {
        ...
        how: [
          ...
          "The preview bar reads Comparing <branch> — <title> to <base> by <author>, and the `view PR #N on GitHub` link opens the pull request. Use the `compare against … instead` link there to switch bases.",
