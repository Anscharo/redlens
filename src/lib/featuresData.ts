    ...
    features: [
      ...
      },
      {
        ...
        how: [
          ...
          "Click a month column in the To Sky by month chart to switch the settlements chart and the figures under it, or press the ▶ play button under the month on the To Sky card to step through the months (it opens paused on the latest). In the left nav, a Prime with settlement workbooks opens into Info and Settlements; on a settlements page every Prime is open, so you can step straight to another Prime's chart.",
