    ...
    features: [
      ...
      },
      {
        ...
        how: [
          ...
          "Under the charts, the selected month's card reads as its two equations: To Sky = cost of funds + Sky Direct Exposure, and retained revenue = supply-side kept + demand-side. The two totals together are that month's gross revenue. A negative figure is written in the same red the charts stripe a loss in.",
