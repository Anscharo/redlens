    ...
    features: [
      {
        ...
        how: [
          ...
          "Look at the sources chips under an answer: where each cited document has been checked against the sentences citing it, a ✓ means the document backs them, a muted mark means it doesn't cover every line citing it, and a warning means it may say otherwise — hover the source to see whether that check is high, medium, or low confidence, and for a warning or a gap which line it is. Click that line to jump to it in the answer. The marks stay when you reopen the chat.",
