    ...
    features: [
      {
        ...
        how: [
          ...
          "Look at the sources chips under an answer: where each cited document has been checked against the sentences citing it, ✓✓ means the document backs them and the check is sure, a single ✓ means it backs them but the check is not sure, ✓⚠ means it backs the line it was cited for with something still worth a look, ⚠ means it doesn't cover a line citing it, and ! means it may say otherwise — hover the source for the reason and, where there is one, the line it is about. Click that line to jump to it in the answer. The marks stay when you reopen the chat.",
          "Read the line under the verification badge: it says \"Didn't answer the question\" when the reply only announced a lookup or stalled, \"Asked you a clarifying question\" or \"Said the atlas doesn't cover this\" when that is what it did, \"Didn't address:\" followed by any part of your question the answer skipped, and how many of the checked sources back the answer, highlighted when a checked source may say otherwise. Nothing is added when the answer simply answers, and the line stays when you reopen the chat.",
