    ...
    features: [
      ...
      },
      {
        ...
        how: [
          ...
          "Scroll — or pinch on a trackpad — over either chart to zoom in on it, which is how you get at the sankey's hairline ribbons and the smallest pies; drag to pan once zoomed, and double-click or press the Reset zoom button to go back. On the sankey the zoom stays put as you step through months; the pies re-crop each month, so they start again at full view.",
