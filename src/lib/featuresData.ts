    ...
    features: [
      ...
      },
      {
        ...
        how: [
          ...
          "Hover a Prime's circle for its gross revenue, a bar segment or Sky wedge for its figure, or an arrow for the To-Sky amount and the share of that Prime's gross revenue it is; hover a timeline segment to light that Prime up on the orbital chart.",
