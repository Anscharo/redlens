    ...
    features: [
      {
        ...
        how: [
          ...
          "Look at the sources chips under an answer: where each cited document has been checked against the sentences citing it, a ✓ means the document backs them, a muted mark means it doesn't cover every line citing it, and a warning means it may say otherwise — hover the ✓ or the ! to see how sure that check is, and hover the warning to see which line. The marks are shown on the live answer only; a reopened chat lists its sources without them.",
          "Read the line under the verification badge: it says \"Didn't answer the question\" when the reply only announced a lookup or stalled, \"Asked you a clarifying question\" or \"Said the atlas doesn't cover this\" when that is what it did, \"Didn't address:\" followed by any part of your question the answer skipped, and how many of the checked sources back the answer, highlighted when a checked source may say otherwise. Nothing is added when the answer simply answers; like the source marks, the line is shown on the live answer only.",
