...
// state + derived rows live in useRoleReportState; this file is render-only.
  ...
  return (
    <div className="px-6 py-6">
      <div className="max-w-5xl mx-auto">
        ...
        <FilterSummary query={query} filters={[filterName, cat && config.categoryLabels[cat]]} searches={config.searches} />
