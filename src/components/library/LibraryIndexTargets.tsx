...
// LibraryIndexList.tsx (in-doc list) and LibraryTopicIndex.tsx (right
// panel) so a topic's targets render identically (and link identically) in
// either surface. See src/lib/libraryIndex.ts for the parse + grouping logic
// this renders.
import { groupTargetsForDisplay, type LibraryIndexTarget } from "../../lib/libraryIndex";

export function TargetLinks({ targets }: { targets: LibraryIndexTarget[] }) {
