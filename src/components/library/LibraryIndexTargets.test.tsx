...
// TargetLinks is exercised indirectly via LibraryTopicIndex.test.tsx and
// LibraryMarkdown.test.tsx's `:::index` case, but neither of those drives a
...
import type { LibraryIndexTarget } from "../../lib/libraryIndex";
...
describe("TargetLinks", () => {
  ...
  it("compacts same-family unit targets, linking each resolved number", () => {
    const targets: LibraryIndexTarget[] = [
