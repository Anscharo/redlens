...
// TargetLinks is exercised indirectly via AnatomyTopicIndex.test.tsx and
// AnatomyMarkdown.test.tsx's `:::index` case, but neither of those drives a
...
import type { AnatomyIndexTarget } from "../../lib/anatomyIndex";
...
describe("TargetLinks", () => {
  ...
  it("compacts same-family unit targets, linking each resolved number", () => {
    const targets: AnatomyIndexTarget[] = [
