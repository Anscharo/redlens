...
// AnatomyIndexList.tsx (in-doc list) and AnatomyTopicIndex.tsx (right
// panel) so a topic's targets render identically (and link identically) in
// either surface. See src/lib/anatomyIndex.ts for the parse + grouping logic
// this renders.
import { groupTargetsForDisplay, type AnatomyIndexTarget } from "../../lib/anatomyIndex";

export function TargetLinks({ targets }: { targets: AnatomyIndexTarget[] }) {
