import type { AnatomySegment } from "../../lib/anatomy";
...
export function SegmentedBar({ value, max, segments }: { value: number; max: number; segments: AnatomySegment[] }) {
  ...
  const segs: (AnatomySegment & { isTail?: boolean })[] =
    tail.length > 1
