// react-markdown `components` map for AnatomyMarkdown.tsx — split out to keep
...
import { groupRefSlug } from "../../lib/anatomyIndex";
...
// with the II.7 topic index's unit-target resolution in anatomyIndex.ts).
