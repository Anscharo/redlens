...
export const PALETTE_TOKENS: readonly PaletteToken[] = [
  ...
  { name: "border-muted", label: "Border Muted", group: "surface", alpha: false },
  ...
  // ─── Depth jewel-tone palette (6-color cycle red→orange→green→blue→purple→magenta starting at depth-1, looping through depth-17) ───
  ...
  { name: "depth-6", label: "Depth 6 (magenta)", group: "depth", alpha: false },
  { name: "depth-7", label: "Depth 7 (red)", group: "depth", alpha: false },
  { name: "depth-8", label: "Depth 8 (orange)", group: "depth", alpha: false },
  { name: "depth-9", label: "Depth 9 (green)", group: "depth", alpha: false },
  { name: "depth-10", label: "Depth 10 (blue)", group: "depth", alpha: false },
  { name: "depth-11", label: "Depth 11 (purple)", group: "depth", alpha: false },
  { name: "depth-12", label: "Depth 12 (magenta)", group: "depth", alpha: false },
  { name: "depth-13", label: "Depth 13 (red)", group: "depth", alpha: false },
  { name: "depth-14", label: "Depth 14 (orange)", group: "depth", alpha: false },
  ...
  { name: "msc-kept", label: "MSC supply-side kept", group: "msc", alpha: false },
  { name: "msc-demand", label: "MSC demand-side", group: "msc", alpha: false },
  { name: "msc-rate", label: "MSC agent rate", group: "msc", alpha: false },
