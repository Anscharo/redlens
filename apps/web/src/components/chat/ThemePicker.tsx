...
// The theme row-group shared by ProfileButton's Account panel and
// SignedOutMenu, replacing the old binary "Light mode" PrefSwitch now that
// the store is a registry of N themes. Renders straight from THEMES — a
// fourth theme needs no edit here. `role="radio"` per row (not `switch`):
// this is a single-select-of-N control, not an on/off toggle.
