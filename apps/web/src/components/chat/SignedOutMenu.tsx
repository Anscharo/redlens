...
// sub-panel, mirroring the signed-in menu's Account panel) and "History".
// History is deliberately here rather than behind the sign-in wall — the
// visit log is browser-local, so it doesn't need an account. Theme lives on
