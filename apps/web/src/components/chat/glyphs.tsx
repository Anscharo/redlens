...
// Three-line menu mark for the signed-out nav pill — its dropdown holds more
// than sign-in now, so the trigger no longer names one of its entries.
export function MenuGlyph({ size = 15 }: { size?: number }) {
  return (
