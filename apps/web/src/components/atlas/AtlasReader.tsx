...
// Lived in the shared src/lib/atlasHelpers until the frontend split: a
// CSSProperties value used by this one component, and keeping it there meant
// the root package needed React types.
const ATLAS_LEFT_PANE_STYLE: CSSProperties = {
