...
// parsing the raw markdown source once (crossviewHeadings.ts) — the SAME
// extraction CrossViewMarkdown/rehypeHeadingIds use to stamp heading ids — so a
